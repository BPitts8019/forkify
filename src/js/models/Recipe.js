        ...
        const newIngredients = this.ingredients.map(item => {
            ...
            if (unitIdx > -1) {
                ...
                objIngredient = {
                    ...
                    name: arrIngredient.slice(unitIdx + 1).join(" ")
                };
                ...
                objIngredient = {
                    ...
                    unit: "",
                    name: arrIngredient.slice(1).join(" ")
                }
            } else if (unitIdx === -1) {
